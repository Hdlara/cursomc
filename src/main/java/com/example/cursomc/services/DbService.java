...
public class DbService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat8 = new Categoria(null, "acessorio");
		Categoria cat9 = new Categoria(null, "celular");
		...
		Cliente cli1 = new Cliente(null, "Maria silva", "maria@gmail.com", "4985064804" , TipoCliente.PESSOA_FISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("1999458936", "023644489"));
		
		Endereco e1 = new Endereco(null, "ruas flores", "40","casa2" ,  "vila azenha ", "17036036000", cli1, c1 );
		Endereco e2 = new Endereco(null, "av mattos", "50","xqe" ,  "zanaga", "31321321", cli1, c2 );
		...
		Pedido ped2 = new Pedido(null, sdf.parse("20/09/2017 10:32"), cli1, e2);
		
		Pagamento pag1 = new PagamentoCartao(null, EstadoPagamento.QUITADO, ped1, 3);
